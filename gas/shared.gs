 ...
 * 元ファイル: server/categories.js, server/classify.js, server/prompts.js, server/failure.js
...
/** タイトル未入力なら失敗の症状から起こす。 */
function failureTitle(title, fields) {
 ...
 */
function buildFailureMarkdown(entry) {
...
function failureSearchText(entry) {
  const fields = (entry && entry.fields) || {};
